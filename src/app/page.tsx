    ...
    <Reveal>
      <div className="flex flex-col justify-center">
        ...
        <h1 className="text-white text-5xl lg:text-6xl font-bold leading-tight mb-6">
          ...
          <span className="text-[#8EE6FF]">precision</span> & intelligent care
        </h1>
...
<section id="about" className="py-28 bg-[#F7F9FC] section-animate activate-glow">
...
<section id="myhealthvaultai" className="py-28 bg-white section-animate">
  <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
    ...
    <div className="section-right">
      ...
      <p className="text-gray-700 text-lg leading-relaxed mb-6">
        MyHealthVaultAI organizes, explains, and secures your entire medical history — giving patients total
        control over their data in one intelligent vault.
      </p>
...
<section id="ai-workflow" className="py-28 bg-[#F7F9FC] section-animate activate-glow">
  <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
    ...
    <div className="section-right">
      ...
      <p className="text-gray-700 text-lg leading-relaxed mb-6">
        Sloane integrates AI systems into medical and aesthetic practices — improving intake automation,
        documentation support, and clinical decision flow.
      </p>
      <p className="text-gray-700 text-lg leading-relaxed mb-6">
        Her work is grounded in real-world clinical workflows, safety, and patient experience.
      </p>
...
<section id="innovation" className="py-28 bg-white section-animate">
  <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
    ...
    <div className="section-right">
      ...
      <p className="text-gray-700 text-lg leading-relaxed mb-6">
        Sloane designs AI-enabled healthcare ecosystems that are safe, understandable,
        and built around real clinical workflows.
      </p>
      <p className="text-gray-700 text-lg leading-relaxed mb-6">
        Her work spans diagnostic support, patient education, automation safety layers,
        and intelligent health data storytelling.
      </p>
...
<section id="luxesculpt" className="py-28 bg-[#F7F9FC] section-animate">
  <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">

    <div className="section-left">
      <h2 className="text-4xl font-bold text-[#0A2A43] leading-snug mb-6">
        LuxeSculpt™ — Medically Inspired High-Performance Compression
      </h2>
      <p className="text-gray-700 text-lg leading-relaxed mb-6">
        LuxeSculpt™ merges elite performance engineering with anatomically informed compression —
        supporting circulation, posture, and kinetic efficiency.
      </p>
      <p className="text-gray-700 text-lg leading-relaxed mb-6">
        Designed for athletes who demand precision, endurance, and structural support
        without sacrificing aesthetics or freedom of movement.
      </p>
    </div>
    ...
    <div className="section-right float-soft">
      <div className="relative w-full h-[480px] rounded-3xl overflow-hidden shadow-xl bg-black depth-hover">
        <Image
          src="/LuxeSculpt.png"
          alt="LuxeSculpt Performance Wear"
          fill
          loading="lazy"
